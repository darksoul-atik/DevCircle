      ...
      <header className="bg-subtle/40 backdrop-blur-md border border-hairline rounded-2xl p-6 md:p-10 mb-8 shadow-sm relative">
        <div className="max-w-3xl">
          <div className="flex items-center gap-6 mb-6">
            <Avatar name={profile.name} url={profile.avatar} size="lg" className="w-20 h-20 text-3xl shadow-sm" />
            <div>
              <h1 className="text-4xl font-display font-bold text-primary mb-1 tracking-tight">{profile.name}</h1>
              {profile.title && (
