...
export default function EditCommunityModal({ community, onClose }: EditCommunityModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="bg-background bg-white w-full max-w-2xl rounded-xl shadow-xl border border-hairline overflow-hidden" onClick={e => e.stopPropagation()}>
        <div className="flex bg-white justify-between items-center p-6 border-b border-hairline">
